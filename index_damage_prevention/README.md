# Alternative Valve Index Controller Profile For Joystick Damage Prevention
...
|    Sprint    | R Touchpad Button | Must either be held down or toggles based on the configuration that is used             |
