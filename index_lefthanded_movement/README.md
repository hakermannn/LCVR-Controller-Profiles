# Alternative Valve Index Controller Profile but with movement and turning actions switch between left and right
...
|       Move       | WASD, Arrow Keys | Right Joystick    |                                                                   |
|       Jump       | Space            | A                 |                                                                   |
...
|     Turn     | L Joystick X Axis | If you have snap/smooth turning enabled, this will determine the direction to rotate in |
|    Pivot     | L Joystick        | Spectator camera pivoting and build mode prop rotating                                  |
|    Sprint    | R Joystick Button | Must either be held down or toggles based on the configuration that is used             |
